...
const SignUp = () => {
  ...
  useEffect(() => {
    // Ensure PayPal button is only initialized once
    if (!paymentStatus && paypalRef.current) {
  ...
  // Capture referral code from URL query parameters if available
  useEffect(() => {
